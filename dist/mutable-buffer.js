...
var MutableBuffer = /** @class */ (function () {
    function MutableBuffer(size, blockSize) {
        ...
        this._buffer = buffer_1.Buffer.alloc(this._initialSize);
        this._size = 0;
    }
    ...
    MutableBuffer.prototype._ensure = function (size) {
        ...
        if (remaining < size) {
            ...
            this._buffer = buffer_1.Buffer.alloc(oldBuffer.length + this._blockSize * factor);
    ...
    MutableBuffer.prototype.write = function (data, encoding) {
        if (buffer_1.Buffer.isBuffer(data)) {
            ...
            data = data + "";
            var len = buffer_1.Buffer.byteLength(data, encoding);
            this._ensure(len);
    ...
    MutableBuffer.prototype.writeFloatLE = function (value, noAssert) {
        this._ensure(4);
        this._size = this._buffer.writeFloatLE(value, this._size, noAssert);
        return this;
    };
    MutableBuffer.prototype.writeFloatBE = function (value, noAssert) {
        this._ensure(4);
        this._size = this._buffer.writeFloatBE(value, this._size, noAssert);
        return this;
    };
    MutableBuffer.prototype.writeDoubleLE = function (value, noAssert) {
        this._ensure(8);
        this._size = this._buffer.writeDoubleLE(value, this._size, noAssert);
        return this;
    };
    MutableBuffer.prototype.writeDoubleBE = function (value, noAssert) {
        this._ensure(8);
